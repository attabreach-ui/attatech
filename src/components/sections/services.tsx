    ...
    <ScrollReveal delay={index * 0.08}>
      <div className="group relative bg-white dark:bg-white/5 border border-black/5 dark:border-white/10 rounded-2xl p-6 hover:-translate-y-2 transition-all duration-300 glow-blue-hover h-full border-gradient">
        <div className="flex items-start gap-4">
          <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-brand-500/20 to-brand-secondary-500/20 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
            <Icon className="w-6 h-6 text-brand-500" />
          </div>
          <div className="flex-1 min-w-0">
            <h3 className="text-lg font-semibold text-[#0a0e27] dark:text-white mb-2 group-hover:text-brand-500 transition-colors">
              {service.title}
            </h3>
