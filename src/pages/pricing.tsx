              ...
              <ScrollReveal key={tier.id} delay={i * 0.1}>
                <div
                  className={cn(
                    ...
                    tier.highlighted
                      ? 'bg-brand-500/5 dark:bg-brand-500/10 border-brand-500/20 shadow-xl shadow-brand-500/10'
                      : 'bg-white dark:bg-white/5 border-black/5 dark:border-white/10 hover:shadow-lg'
                  )}
                >
                  {tier.highlighted && (
                    <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                      <span className="px-4 py-1.5 bg-brand-500 text-white text-xs font-semibold rounded-full flex items-center gap-1">
                  ...
                  <ul className="space-y-3 mb-8">
                    {tier.features.map((feature, fi) => (
                      <li key={fi} className="flex items-start gap-3 text-sm">
                        <div className="w-5 h-5 rounded-full bg-brand-500/10 dark:bg-brand-500/20 flex items-center justify-center shrink-0 mt-0.5">
                  ...
                  <a
                    ...
                    className={cn(
                      ...
                      tier.highlighted
                        ? 'bg-brand-500 hover:bg-brand-600 text-white shadow-lg shadow-brand-500/25 hover:shadow-xl hover:-translate-y-0.5'
